...
int main() {
	...
	std::cout << "\t\t\tPosition  (" << sizeof(DgVertex::position) << " bytes, offset " << offsetof(DgVertex, position) << ")" << std::endl;
	std::cout << "\t\t\tColor     (" << sizeof(DgVertex::color) << " bytes, offset " << offsetof(DgVertex, color) << ")" << std::endl;
	std::cout << "\t\t\tNormal    (" << sizeof(DgVertex::normalVec) << " bytes, offset " << offsetof(DgVertex, normalVec) << ")" << std::endl;
	std::cout << "\t\t\tShininess (" << sizeof(DgVertex::shininess) << " bytes, offset " << offsetof(DgVertex, shininess) << ")" << std::endl;
	std::cout << "\t\tData Per Model:" << std::endl;
	std::cout << "\t\t\tRotation  (" << sizeof(DgModel::rotation) << " bytes, offset " << sizeof(DgVertex) << ")" << std::endl;
